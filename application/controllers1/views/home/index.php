    ...
    <section id="online_booking-main" class="online_booking-main">
        <div class="container">
          <div class="from-outer">
              <div class="row">
                 ...
                 <form action="<?php echo base_url();?>welcome/insert_booking" method="post">
								...
								<input type="email" class="form-control" name = "email"  placeholder="Email*" required>
                                                         ...
                                                         <div class="col-sm-6">
							<div class="form-group">
						          <input type="text" class="form-control" name="num" placeholder="Mobile No.*" required>
							 </div>
                                                        </div> 
             ...
             onFocus="geolocate()"  name="p_address" type="text"></input>
							 </div>
                                                        </div>
     ...
     <input id="autocomplete1" class="form-control" placeholder="Enter your address"
...
<div class="col-sm-4">
							  <div class="form-group">
                                                               <select class="form-control" name="l_count">
                                                                   <option>No of Luggage</option> 
                                                                   <option value="1">1</option> 
                                                                   <option value="2">2</option> 
                                                                   <option value="3">3</option> 
                                                               </select>
